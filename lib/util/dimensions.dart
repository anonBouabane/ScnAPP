...
class Dimensions {
  ...
  static double fontSizeExtraLarge = Get.context!.width >= 1300 ? 16 : 16;
  // static double fontSizeExtraLarge = Get.context!.width >= 1300 ? 22 : 18;
  static double fontSizeExtraLarge1 = Get.context!.width >= 1300 ? 24 : 20;
  static double fontSizeOverLarge = Get.context!.width >= 1300 ? 28 : 24;
  static double fontSizeHugeLarge2 = Get.context!.width >= 1300 ? 34 : 28;
  static double fontSizeHugeLarge1 = Get.context!.width >= 1300 ? 40 : 36;
  static double fontSizeHugeLarge = Get.context!.width >= 1300 ? 50 : 46;

  static const double PADDING_SIZE_EXTRA_SMALL = 5.0;
  static const double PADDING_SIZE_EXTRA_SMALLER = 2.0;
