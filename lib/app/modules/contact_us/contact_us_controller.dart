...
import 'package:scn_easy/app/modules/contact_us/contact_us_model.dart';
...
class ContactUsController extends GetxController with StateMixin<ContactModel> {
  final contactUsService = Get.put(ContactUsService());
  ...
  getContactUs() async {
    ...
    try {
      var res = await contactUsService.loadContactUs();
